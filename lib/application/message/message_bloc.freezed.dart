...
class _$GetAllMessagesImpl implements _GetAllMessages {
  ...
  @override
  String toString() {
    return 'MessageEvent.getAllMessages()';
  }
...
class _$MessageStateImpl implements _MessageState {
  const _$MessageStateImpl(
      {required final List<Message> messageList,
  ...
  @override
  String toString() {
    return 'MessageState(messageList: $messageList, isLoading: $isLoading, apiFailureOrSuccessOption: $apiFailureOrSuccessOption)';
  }
...
abstract class _MessageState implements MessageState {
  const factory _MessageState(
      ...
      required final Option<Either<ApiFailure, dynamic>>
          apiFailureOrSuccessOption}) = _$MessageStateImpl;
