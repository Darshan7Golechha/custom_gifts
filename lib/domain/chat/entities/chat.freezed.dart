...
class _$ChatImpl extends _Chat {
  ...
  @override
  String toString() {
    return 'Chat(createdDate: $createdDate, message: $message, imageURL: $imageURL, videoURL: $videoURL, voiceURL: $voiceURL, senderUserID: $senderUserID, conversationID: $conversationID)';
  }
...
abstract class _Chat extends Chat {
  const factory _Chat(
      ...
      required final String conversationID}) = _$ChatImpl;
